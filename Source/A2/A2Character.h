...
/*------------DAMIAN CODE---------------------*/
	...
	//want this function to handle what happens when a certain pickup is detected
	//UFUNCTION()
	//void ManagePickup(APickup* DetectedPickup);

	//UFUNCTION()
	//void SwitchLogic(UWorld* World , ADoor* SwitchDoor, ASwitch* Switch);
